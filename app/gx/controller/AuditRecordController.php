...
use app\gx\logic\AuditRecordLogic;
use app\gx\validate\AuditRecordValidate;
use support\Request;
 ...
 * @Apidoc\Title("审核记录表")
 */
class AuditRecordController extends BaseController
{
    ...
    {
        $this->logic = new AuditRecordLogic();
        $this->validate = new AuditRecordValidate;
        parent::__construct();
    }

    /**
     * @Apidoc\Title("数据列表")
     * @Apidoc\Url("/gx/AuditRecord/index")
     * @Apidoc\Method("GET")
    ...
    /**
     * @Apidoc\Title("保存数据")
     * @Apidoc\Url("/gx/AuditRecord/save")
     * @Apidoc\Method("POST")
     * @Apidoc\Query("auditor_id", type="int", require=false, desc="审核人ID", default="")
     * @Apidoc\Query("audit_result", type="int", require=false, desc="审核结果", default="")
     * @Apidoc\Query("audit_comment", type="varchar", require=false, desc="审核意见", default="")
     * @Apidoc\Query("remark", type="varchar", require=false, desc="备注", default="")
     * @param Request $request
     * @return Response
     */
    ...
    /**
     * @Apidoc\Title("修改数据")
     * @Apidoc\Url("/gx/AuditRecord/update")
     * @Apidoc\Method("PUT")
    ...
    /**
     * @Apidoc\Title("读取数据")
     * @Apidoc\Url("/gx/AuditRecord/read")
     * @Apidoc\Method("GET")
     * @Apidoc\Query("id", type="int", require=true, desc="主键", default="")
     * @param Request $request
     * @param $id
    ...
    /**
     * @Apidoc\Title("修改状态")
     * @Apidoc\Url("/gx/AuditRecord/changeStatus")
     * @Apidoc\Method("POST")
    ...
    /**
     * @Apidoc\Title("删除数据")
     * @Apidoc\Url("/gx/AuditRecord/destroy")
    ...
    /**
     * @Apidoc\Title("回收站数据")
     * @Apidoc\Url("/gx/AuditRecord/recycle")
     * @Apidoc\Method("GET")
     * @Apidoc\Query("page", type="int", require=false, desc="框架自带-页码,默认1", default="1")
     * @Apidoc\Query("limit", type="int", require=false, desc="框架自带-每页数据,默认10", default="10")
     * @Apidoc\Query("saiType", type="string", require=false, desc="框架自带-获取数据类型;默认list分页;all全部数据", default="list")
    ...
    /**
     * @Apidoc\Title("恢复数据")
     * @Apidoc\Url("/gx/AuditRecord/recovery")
     * @Apidoc\Method("POST")
     * @Apidoc\Param("ids", type="string|array", require=true, desc="主键", default="")
     * @param Request $request
     * @return Response
    ...
    /**
     * @Apidoc\Title("销毁数据")
     * @Apidoc\Url("/gx/AuditRecord/realDestroy")
     * @Apidoc\Method("DELETE")
     * @Apidoc\Param("ids", type="string|array", require=true, desc="主键", default="")
     * @param Request $request
     * @return Response
